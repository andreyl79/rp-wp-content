<?php get_header(); ?>
				...
				<div class="projects-items">
						...
						<div class="item">
							<div class="item__content a--1x1">
								<div class="item-content__img a--fixed">
									<img src="assets/projects/1.jpg" alt="test">
								</div>
					...
					<div class="item__container">
						<div class="item">
							<div class="item__content a--1x1">
								<div class="item-content__img a--fixed">
									<img src="assets/projects/2.jpg" alt="test">
								</div>
								<div class="item-descr">
									<p class="short-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores distinctio doloremque, eius eos est excepturi iste, maiores pariatur quam recusandae saepe similique, tempora temporibus ullam voluptatem. Distinctio eos officia quod.</p>
									<button class="btn-projects-readmore">Подробней</button>
					...
					<div class="item__container">
						<div class="item">
							<div class="item__content a--1x1">
								<div class="item-content__img a--fixed">
									<img src="assets/projects/3.jpg" alt="test">
								</div>
								<div class="item-descr">
									<p class="short-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores distinctio doloremque, eius eos est excepturi iste, maiores pariatur quam recusandae saepe similique, tempora temporibus ullam voluptatem. Distinctio eos officia quod.</p>
									<button class="btn-projects-readmore">Подробней</button>
					...
					<div class="item__container">
						<div class="item">
							<div class="item__content a--1x1">
								<div class="item-content__img a--fixed">
									<img src="assets/projects/4.jpg" alt="test">
								</div>
								<div class="item-descr">
									<p class="short-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores distinctio doloremque, eius eos est excepturi iste, maiores pariatur quam recusandae saepe similique, tempora temporibus ullam voluptatem. Distinctio eos officia quod.</p>
									<button class="btn-projects-readmore">Подробней</button>
					...
					<div class="item__container">
						<div class="item">
							<div class="item__content a--1x1">
								<div class="item-content__img a--fixed">
									<img src="assets/projects/6.jpg" alt="test">
								</div>
								<div class="item-descr">
									<p class="short-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores distinctio doloremque, eius eos est excepturi iste, maiores pariatur quam recusandae saepe similique, tempora temporibus ullam voluptatem. Distinctio eos officia quod.</p>
									<button class="btn-projects-readmore">Подробней</button>
	...
	<section class="partners">
		<div class="container">
			...
			<div class="section-content">
				<div class="partner">
					<a href="#" class="partner__link"><img class="partner__logo koshel-color" src="assets/partnr/logo_color/koshel.png" alt=""></a>
					<button class="btn-readmore">перейти на сайт</button>
				</div>
				<div class="partner">
					<a href="#" class="partner__link"><img class="partner__logo dom-color" src="assets/partnr/logo_color/logo.png" alt=""></a>
					<button class="btn-readmore">перейти на сайт</button>
				</div>
				<div class="partner">
					<a href="#" class="partner__link"><img class="partner__logo bazis-color" src="assets/partnr/logo_color/bazis.png" alt=""></a>
					<button class="btn-readmore">перейти на сайт</button>
				</div>
				<div class="partner">
					<a href="#" class="partner__link"><img class="partner__logo spectr-color" src="assets/partnr/logo_color/spectr.png" alt=""></a>
					<button class="btn-readmore">перейти на сайт</button>
				</div>
			</div>
		</div>
